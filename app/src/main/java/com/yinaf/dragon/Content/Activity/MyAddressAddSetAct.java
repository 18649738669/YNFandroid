...
import com.yinaf.dragon.Content.Net.MyAddressSetAddAPI;
import com.yinaf.dragon.Content.Net.MyAddressSetUpdateAPI;
 ...
 * 用户 - 添加地址
 */
public class MyAddressAddSetAct extends BasicAct implements MyAddressSetAddAPI.AddressSetAddListener, MyAddressSetUpdateAPI.AddressSetUpdateListener {
    ...
    private MyAddressSetModel.ObjBean objBean;
    private String province;
    private int memberId;
    private LoadingDialog loadingDialog;

    public MyAddressAddSetAct() {
    ...
    public void initView() {
        ...
        if (type == 1) {
            objBean = (MyAddressSetModel.ObjBean) getIntent().getExtras().getSerializable("model");
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_add:
                ...
                if (type == 0 && TextUtils.isEmpty(edtName.getText().toString())
                    ...
                    loadingDialog.show();
                    new MyAddressSetUpdateAPI(this, memberId, edtName.getText().toString()
                            , edtAddress.getText().toString(), edtPhone.getText().toString()
                            , province, defcode, "", objBean.getAuId() + "");

                } else {
                    loadingDialog.show();
                    new MyAddressSetAddAPI(this, memberId, edtName.getText().toString()
                            , edtAddress.getText().toString(), edtPhone.getText().toString()
                            , province, defcode, "");
                }
