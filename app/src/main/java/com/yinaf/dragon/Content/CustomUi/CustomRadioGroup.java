...
public class CustomRadioGroup extends LinearLayout {
    ...
    public CustomRadioGroup(Context context, AttributeSet attributeSet, int defStyle){
    ...
    public void setInitChecked(int index){
        ((CustomRadioBtn)map.get(index)).setTouch(2);
        setCurrentValue(((CustomRadioBtn)map.get(index)).getText().toString());
    }
    ...
    public void setView(final Context context){
        ...
        for(int i=0;i<row;i++){
            ...
            for(int j=0;j<column;j++){
                final CustomRadioBtn button = new CustomRadioBtn(context);
...
//                layoutParams.setMargins(8, 8, 8, 8);
                ...
                button.setOnValueChangedListner(new CustomRadioBtn.OnValueChangedListner() {
                    @Override
...
//                    layoutParamsV.setMargins(8, 8, 8, 8);
                    layoutParamsV.setMargins(20, 20, 20, 20);
    ...
    private void clearSelected(int Index){
        ...
        for(int index = 0;index < map.size(); index ++){
            ...
            ((CustomRadioBtn)map.get(index)).setTouch(1);
        }
    }
