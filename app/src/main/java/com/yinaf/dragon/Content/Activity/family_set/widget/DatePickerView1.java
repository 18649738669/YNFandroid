package com.yinaf.dragon.Content.Activity.family_set.widget;
 ...
 */
public class DatePickerView1 extends View {
    ...
    public DatePickerView1(Context context, AttributeSet attrs) {
        super(context, attrs);
