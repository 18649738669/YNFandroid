...
public class BloodPressureDataAdapter extends BasicAdapter{

    private List<ThreeTextData> date;

    public BloodPressureDataAdapter(List<ThreeTextData> data) {
    ...
    public void bind(BasicViewHolder viewHolder, int position) {
        ...
        switch (threeTextData.getType()){
            case 0:
                linearLayout.setBackgroundResource(R.color.common_orange);
