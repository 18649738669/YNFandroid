package com.yinaf.dragon.Content.Utils.DoorLock.task;
...
import com.yinaf.dragon.Content.Utils.DoorLock.EsptouchResult;
...
import com.yinaf.dragon.Content.Utils.DoorLock.protocol.EsptouchGenerator;
import com.yinaf.dragon.Content.Utils.DoorLock.udp.UDPSocketClient;
import com.yinaf.dragon.Content.Utils.DoorLock.udp.UDPSocketServer;
import com.yinaf.dragon.Content.Utils.DoorLock.util.ByteUtil;
import com.yinaf.dragon.Content.Utils.DoorLock.util.EspNetUtil;
...
public class __EsptouchTask implements __IEsptouchTask {
	...
	public List<IEsptouchResult> executeForResults(int expectTaskResultCount)
		...
		IEsptouchGenerator generator = (IEsptouchGenerator) new EsptouchGenerator(mApSsid, mApBssid,
